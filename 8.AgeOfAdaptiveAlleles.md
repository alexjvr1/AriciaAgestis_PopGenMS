...
ind.hap<-with(stack(setNames(attr(h, "index"), rownames(h))), table(hap=ind, pop=loc1.popnames$V5))     
...
three.colours <- c("gold1", "gold3", "darkorchid")
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(-5,-2, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
...
three.colours <- c("gold1", "gold3", "darkorchid")
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(4,-2, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
...
three.colours <- c("gold1", "gold3", "darkorchid")
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(1,1, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
...
three.colours <- c("gold1", "gold3", "darkorchid")
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(5,8, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
...
three.colours <- c("gold1", "gold3", "darkorchid")
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(3,5, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
...
three.colours <- c("gold1", "gold3", "darkorchid")
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(0,1, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
...
three.colours <- c("gold1", "gold3", "darkorchid")
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(-8,2, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
...
three.colours <- c("gold1", "gold3", "darkorchid")
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(-10,-2, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
...
three.colours <- c("gold1", "gold3", "darkorchid")
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(-12,-4, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
...
three.colours <- c("gold1", "gold3", "darkorchid")
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(1,2, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
...
three.colours <- c("gold1", "gold3", "darkorchid")
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(-2,2, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
...
three.colours <- c("gold1", "gold3", "darkorchid")
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(-2,1, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
