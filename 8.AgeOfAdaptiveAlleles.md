...
grep "##contig" AA261.0.5miss.9popsMerged.MAF0.05.recode.vcf >> contig.names
cat contig.names | awk -F "=" '{print $3}' >> contig.names2
cat contig.names2 | awk -F "," '{print $1}' >> contig.names3
shuf -n20 contig.names3 >> contig.names.neutral20
