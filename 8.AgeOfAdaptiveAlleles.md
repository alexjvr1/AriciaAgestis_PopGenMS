...
And repeat for all the haplotypes. 
...
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(-5,-2, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
title("contig_12160: 3 SNPs") ##change the title for each plot
dev.off()
...
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(-5,-2, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
title("contig_1985: 3 SNPs") ##change the title for each plot
dev.off()
...
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(-5,-2, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
title("contig_2229: 3 SNPs") ##change the title for each plot
dev.off()
...
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(-5,-2, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
title("contig_2334: 3 SNPs") ##change the title for each plot
dev.off()
...
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(-5,-2, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
title("contig_30084: 3 SNPs") ##change the title for each plot
dev.off()
...
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(-5,-2, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
title("contig_31360: 3 SNPs") ##change the title for each plot
dev.off()
...
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(-5,-2, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
title("contig_3461: 3 SNPs") ##change the title for each plot
dev.off()
...
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(-5,-2, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
title("contig_37637: 3 SNPs") ##change the title for each plot
dev.off()
...
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(-5,-2, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
title("contig_38039: 3 SNPs") ##change the title for each plot
dev.off()
...
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(-5,-2, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
title("contig_4506: 3 SNPs") ##change the title for each plot
dev.off()
...
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(-5,-2, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
title("contig_662: 3 SNPs") ##change the title for each plot
dev.off()
...
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(-5,-2, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
title("contig_75445: 3 SNPs") ##change the title for each plot
dev.off()
...
plot(net, scale.ratio = 2, cex = 0.8, pie=ind.hap, bg=three.colours)
legend(-5,-2, colnames(ind.hap), col=three.colours, pch=20)  ##The legend needs to be moved for each plot
title("contig_916: 3 SNPs") ##change the title for each plot
dev.off()
```
