...
~/software/BayeScan2.1/binaries/BayeScan2.1_linux64bits AA216.HostPlant.bayescan -output AA216.HostPlant.out -n 5000 -thin 10 -nbp 20 -pilot 5000 -burn 50000 -pr_odds 20
...
##The project is saved into :AAgestis.212.3228.recode.snmfProject 

##To load the project, use:

project = load.snmfProject("AAgestis.212.3228.recode.snmfProject")

##To remove the project, use: remove.snmfProject("AAgestis.212.3228.recode.snmfProject")
