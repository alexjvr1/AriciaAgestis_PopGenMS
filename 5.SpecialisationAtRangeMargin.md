...
RDA.AA261.full.North <- rda(GenData ~ colhist + HostPlant + Lat + Long, Climate.Data.North)
...
Constrained   120.7688     0.8767    4
Unconstrained  16.9821     0.1233    1
Inertia is variance 

Eigenvalues for constrained axes:
 RDA1  RDA2  RDA3  RDA4 
39.72 32.54 26.52 21.99 

Eigenvalues for unconstrained axes:
   PC1 
16.982 

##This model explains ~87% of the genetic variation. The unconstrained PC explain less than half of RDA1. 
...
Model: rda(formula = GenData ~ colhist + HostPlant + Lat + Long, data = Climate.Data.North)
         Df Variance      F  Pr(>F)  
Model     4  120.769 1.7779 0.04167 *
Residual  1   16.982                 
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
Set of permutations < 'minperm'. Generating entire set.
            ...
            Df    AIC      F Pr(>F)  
- Long       1 29.259 1.4434  0.185  
- colhist    1 29.587 1.5805  0.110  
- Lat        1 29.639 1.6031  0.105  
- HostPlant  1 29.560 1.5689  0.095 .
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Step: GenData ~ colhist + HostPlant + Lat 
Set of permutations < 'minperm'. Generating entire set.

            Df    AIC      F Pr(>F)  
- HostPlant  1 30.110 1.2161  0.285  
- colhist    1 31.003 1.7326  0.025 *
- Lat        1 31.100 1.7932  0.020 *
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
Set of permutations < 'minperm'. Generating entire set.
          ...
          Df    AIC      F Pr(>F)   
- Lat      1 30.788 1.6880  0.015 * 
- colhist  1 30.736 1.6479  0.005 **
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

```

Still only Lat and colhist are significant. 
...
Constrained    36.6506     0.2661    1
Unconstrained  66.7240     0.4844    3
Inertia is variance 
