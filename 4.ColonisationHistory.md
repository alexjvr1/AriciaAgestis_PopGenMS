...
First remove all loci under selection. For this I need to identify a list of outliers for 1) host plant preference, and 2) colonisation history. A large number of these overlap. 
```
...
I'm using [this](https://github.com/shenglin-liu/vcf2sfs) script to generate 2D folded SFS for FOR (called North), HOD, South, and New populations. 
