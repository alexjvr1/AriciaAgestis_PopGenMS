...
NB - We're not filtering linked loci because in the next step we will subsample SNPs within a linked block to obtain SFS data for each locus with enough data. 
