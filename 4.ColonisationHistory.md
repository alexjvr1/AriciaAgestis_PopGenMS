...
```
vcftools --vcf AA251.FINAL.MAF0.01.missing0.5perpop.Neutral.recode.vcf --thin 10000 --recode --recode-INFO-all --out AA251.Neutral.thin

After filtering, kept 251 out of 251 Individuals
Outputting VCF file...
After filtering, kept 6211 out of a possible 60994 Sites
Run Time = 4.00 seconds



##If thinning for 600bp (i.e. size of RAD tags) we get 7306 loci. 
```
