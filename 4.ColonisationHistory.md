...
First remove all loci under selection. For this I need to identify a list of outliers for 1) host plant preference, and 2) colonisation history. Three of these overlaps.
```
pwd
/newhome/aj18951/1a_Aricia_agestis_PopGenomics/FastSimCoal
...
```
##Remove Z-chromosome and mitochondrial chr. 
