...
Dgen <- dist.genpop(AA264.genpop, method=1)
...
Mantel statistic r: 0.1881 
      Significance: 0.109 

Upper quantiles of permutations (null model):
  90%   95% 97.5%   99% 
0.190 0.301 0.416 0.447 
Permutation: free
Number of permutations: 999
...
Mantel statistic r: 0.4225 
      Significance: 0.026 

Upper quantiles of permutations (null model):
  90%   95% 97.5%   99% 
0.188 0.301 0.416 0.447 
Permutation: free
Number of permutations: 999
```
...
popnames <- read.table("../Bayescan/popnames.pgdspider")
df$pop <- popnames$V2
...
df2 <- melt(df.sorted, id=c("pop", "indiv", "index"),)
