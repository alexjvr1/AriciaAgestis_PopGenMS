...
# NOTE: at least 3 pops need to be defined to create the 2D SFS
...
#vcffile="filtered_3scaf";   #example file
vcffile="AA251.FINAL.FSC.recode"
# tag for the resulting files
vcftag=MODEL1_${vcffile};
...
#indidpop="IndPopInfo_OffOnSH.txt";  #example file
indidpop="AA251.4pops.popfile"
# tag for folder with output data
outSFSfolder="AA251_4pops_SFS";
# block size in bp
block_length=1000;
...
#ind_threshold="3,4,5";  #when running 3 pops (NEW, SOUTH, HOD). 4pops = NEW, SOUTH, FOR, HOD
ind_threshold="5,5,3,3";
