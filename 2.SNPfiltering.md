...
vcftools --vcf AA.264.41508_FINAL.recode.vcf --thin 600 --recode --recode-INFO-all --out
AA264.merge0.5missing.thin600.recode.vcf
...
##### 4. Heterozygosity: based on loci genotyped in 50% of individuals in each population
...
AA264 <- read.vcfR("AA264.merge0.5missing.vcf", nrows=31522)
...
Character matrix gt created.
  Character matrix gt rows: 31522
  Character matrix gt cols: 273
  skip: 0
  nrows: 31522
  row_num: 0
Processed variant: 31522
...
AA.genind@pop <- as.factor(AA264.pop$pop)
...
##### 5. Allelic diversity: based on loci genotyped in 50% of individuals in each population. 
