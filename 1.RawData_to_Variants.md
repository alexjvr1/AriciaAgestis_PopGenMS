...
[meanDP]:https://user-images.githubusercontent.com/12142475/53204877-a9fa8180-3624-11e9-8c93-fd0469a2d6b3.png
...
```
out.imiss <- read.table("out.imiss_vcf.filtered", header=T)
...
[Nvariants]:https://user-images.githubusercontent.com/12142475/53206528-1b3c3380-3629-11e9-8f86-d5ae1d5b2086.png
...
ggplot(Tot.filtered, aes(x=N_Variants, y=MEAN_DEPTH, colour=pop)) + geom_point()
dev.off()
```

![alt_txt][variants_DP]

[variants_DP]:https://user-images.githubusercontent.com/12142475/53206802-cf3dbe80-3629-11e9-8d63-c19a740a0fc8.png
